...
public class Constants {
    ...
    public static final String TIMBER1 = "Esteem1";
    public static final String TIMBER2 = "Esteem2";
    public static final String TIMBER3 = "Esteem3";
    public static final String TIMBER4 = "Esteem4";
    public static final String TIMBER5 = "Esteem5";
    public static final String TIMBER6 = "Esteem6";
